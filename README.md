...
|------|-------------|------|------|
| `schema_seed/` | chewBBACA schema seed | ~2 GB | https://zenodo.org/records/20128405 |
| `presence_absence.tsv` | Loci presence/absence matrix | ~300 MB | https://zenodo.org/records/20127814 |
